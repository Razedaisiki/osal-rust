...
PROFILES = {
    ...
    "queue-blocking": {
        "cases": [
            ...
            "queue_recv_timeout_wake_race",
            "queue_send_timeout_wake_race",
            "queue_recv_close_timeout_priority",
            "queue_send_close_timeout_priority",
        ],
        "fields": [
    ...
    "task": {
        ...
        "fields": [
            ...
            "task_timeout=true",
            "task_self_join=true",
            "task_concurrent_join=true",
            "task_cached_join=true",
            "task_drop=true",
            "task_scheduler=true",
            "task_mapping=true",
            "task_rollback=true",
    ...
    "timer": {
        "cases": [
            ...
            "timer_start_reset",
            "timer_stop",
            "timer_change_period_stopped",
            "timer_change_period_running",
            "timer_periodic_coalescing",
            "timer_callback_self_control",
            "timer_callback_cross_timer",
            "timer_clone_last_drop",
            "timer_inflight_last_drop",
            "timer_callback_drop_outside_lock",
            "timer_scheduler_suspended",
            "timer_shutdown_lease",
            "timer_self_shutdown_busy",
            "timer_same_deadline_order",
            "timer_lifecycle_stress",
        ],
        "fields": [
            "profile=timer",
            "timer=true",
